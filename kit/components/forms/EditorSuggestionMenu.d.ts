...
export type EditorSuggestionMenuSize = "xs" | "sm" | "md" | "lg" | "xl";
export type EditorSuggestionMenuActive = boolean;

export interface EditorSuggestionMenuProps {
  /** themes/editor-suggestion-menu.ts -> variants.size */
  size?: EditorSuggestionMenuSize;
  /** themes/editor-suggestion-menu.ts -> variants.active */
  active?: EditorSuggestionMenuActive;
...
export function EditorSuggestionMenu(props: EditorSuggestionMenuProps): JSX.Element;

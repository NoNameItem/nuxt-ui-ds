InputDate — Nuxt UI 4.11.1 `UInputDate`; classes come straight from themes/input-date.ts.

```jsx
<InputDate fieldGroup="horizontal" size="xs" variant="outline">Content</InputDate>
```

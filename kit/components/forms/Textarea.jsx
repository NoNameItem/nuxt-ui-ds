...
/* @nuxt/ui 4.11.1 — theme copied verbatim from themes/textarea.ts (source/themes.json -> "textarea").
...
/* DOM extracted from Textarea.vue — element nesting and data-slot names as shipped. */
const tree = [{"t":"Primitive","s":"root","c":[{"t":"textarea","s":"base"},{"t":"span","s":"leading","if":1,"c":[{"t":"slot","c":[{"t":"UIcon","s":"leadingIcon","if":1},{"t":"UAvatar","s":"leadingAvatar","if":1}]}]},{"t":"span","s":"trailing","if":1,"c":[{"t":"slot","c":[{"t":"UIcon","s":"trailingIcon","if":1}]}]}]}];

const render = createRenderer('textarea', textareaTheme, tree);

...
/* @nuxt/ui 4.11.1 — theme copied verbatim from themes/slideover.ts (source/themes.json -> "slideover").
...
/* DOM extracted from Slideover.vue — element nesting and data-slot names as shipped. */
const tree = [{"t":"DialogRoot","c":[{"t":"DialogPortal","c":[{"t":"FieldGroupReset","c":[{"t":"DialogOverlay","s":"overlay","if":1},{"t":"DialogContent","s":"content","c":[{"t":"slot","c":[{"t":"div","s":"header","if":1,"c":[{"t":"slot","c":[{"t":"div","s":"wrapper","if":1,"c":[{"t":"DialogTitle","s":"title","if":1},{"t":"DialogDescription","s":"description","if":1}]},{"t":"DialogClose","if":1,"c":[{"t":"slot","c":[{"t":"UButton","s":"close","if":1}]}]}]}]},{"t":"div","s":"body"},{"t":"div","s":"footer","if":1}]}]}]}]}]}];

const render = createRenderer('slideover', slideoverTheme, tree, { portal: true, /* the theme's `fixed` stays fixed, as in Drawer */ keepFixed: ['content'], /* reka moves the focus into an open dialog, onto its close button */ focusOnOpen: 'close', openOnlySlots: ['overlay', 'content'], /* like Modal: the caller's class lands on the content, not the overlay */ primarySlot: 'content' });
